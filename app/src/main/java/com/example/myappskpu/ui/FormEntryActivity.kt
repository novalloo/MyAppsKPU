...
import com.example.myappskpu.camera.CameraActivity
import com.example.myappskpu.camera.rotateBitmap
import com.example.myappskpu.camera.uriToFile
import com.example.myappskpu.database.DataPemilih
import com.example.myappskpu.databinding.ActivityFormEntryBinding
import com.example.myappskpu.helper.ViewModelFactory
import com.example.myappskpu.maps.MapsActivity
                ...
                datapemilih?.let { datapemilih ->
                    ...
                    if (datapemilih?.gambar != null) {
                        ...
                        Glide.with(applicationContext)
                            .load(R.drawable.photo) // Ganti dengan resource ID placeholder yang sesuai
